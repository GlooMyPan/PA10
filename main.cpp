...
/***  lese Datei in einen String ein  ***/
    ...
    // rohartikel ist leer, wenn die Datei nicht gelesen werden konnte
    if ( rohartikel.empty() )
    {
        cerr << "kann Datei " << dateiName << " nicht oeffnen!" << endl ;
        return -1 ;		// willk黵licher Signalwert
    }
...
/***  gebe ganzen Artikel im Spaltensatz auf cout aus  ***/
    ...
    if ( rohartikel.size() <= 400 )
    {
        ...
        cout << string( 40, '-' ) << endl ;		// was passiert hier?
        cout << rohartikel << endl ;
        cout << string( 40, '-' ) << endl ;
        cout << endl ;
    }
